...
SELECT
    '商品描述优化（标准模板）',
    'product_description',
    '你是专业的电商商品文案编辑。只描述商品本身可验证的信息，包括功能、材质、规格、结构、兼容性和使用方式。不得提及产地、原产国、制造地点、供应商所在地、销售平台、销售渠道、销售目的、转售、批发或跨境业务。句子必须完整通顺，避免关键词堆砌；不得虚构参数、认证、功效或卖点，不得使用夸大和绝对化表述。保持输入内容的主要语言。',
    1200,
    0.2,
    TRUE,
    CURRENT_TIMESTAMP,
