    ...
    'configuration' => [
        ...
        'platform' => [
            ...
            'fields' => [
                ...
                'reasoning-low'            => '快速（low，推荐用于商品分类）',
                'reasoning-high'           => '增强（high）',
                'reasoning-max'            => '深度（max）',
                'reasoning-hint'           => 'GLM 5.x 默认使用 low，以缩短商品分类等待时间。',
                'is-default'               => '设为默认',
                'status'                   => '状态',
                'use-default'              => '使用默认平台',
            ...
            'message' => [
                ...
                'test-success'                     => '连接验证成功！',
                'test-fail'                        => '连接测试失败',
                'model-test-success'               => '模型调用成功。',
                'model-test-fail'                  => '模型调用失败',
